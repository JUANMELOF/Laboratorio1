...
def setup_ventana(reproductor):
    ...
    reproductor.canciones = [
        "sounds/chopsuey.mp3", "sounds/Slipknot.mp3","sounds\Beethoven - Für Elise.mp3"]
    ...
    labelImagen = tk.Label(reproductor.ventana, image=iconos["satan"])
    ...
    reproductor.btnDevolver10 = tk.Button(reproductor.ventana, image=iconos["retroceder"], bg="gray")
    ...
    reproductor.btnAdelantar10 = tk.Button(reproductor.ventana, image=iconos["adelantar"], bg="gray")
    ...
    reproductor.btnDevolver = tk.Button(reproductor.ventana, image=iconos["devolver"], bg="gray")
    ...
    reproductor.btnPasar = tk.Button(reproductor.ventana, image=iconos["pasar"], bg="gray")
    ...
    reproductor.btnPlay = tk.Button(reproductor.ventana, image=iconos["play"], bg="green")
    ...
    reproductor.btnStop = tk.Button(reproductor.ventana, image=iconos["stop"], state="disabled", bg="gray")
